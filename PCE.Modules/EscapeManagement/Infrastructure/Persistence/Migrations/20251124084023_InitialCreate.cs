        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerPerson = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EscapeRooms_Companies_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EscapeRooms_CompanyId",
                table: "EscapeRooms",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_EscapeRooms_Slug",
                table: "EscapeRooms",
                column: "Slug",
                unique: true);
        }
