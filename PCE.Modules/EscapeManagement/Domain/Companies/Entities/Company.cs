...
public class Company : BaseEntity
{
    ...
    public static Company Create(string name, string email, string phone, string? address = null, string? website = null)
    {
        return new Company
        {
            Id = Guid.NewGuid(),
    ...
    public void Update(string name, string email, string phone, string? address = null, string? website = null)
    {
        if (Name != name)
        {
            Slug = Slug.Create(name);
